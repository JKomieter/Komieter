        ...
        <div className='flex flex-col gap-14 h-full w-full'>
            ...
            >
                ...
                <p className={`${red_hat_display.className} text-neutral-600`}>
                    I'm a Software Engineer based in the United States. I have a passion for building systems that power
                    applications and provide tools for developers. My goal is to always build reliable, efficient, and
                    performant systems that enhance productivity and provide pixel-perfect experiences.
                </p>
            </div>
            <div
                ref={skillsRef}
            ...
            >
                ...
                <p className={`${red_hat_display.className} text-neutral-600`}>
                    I bring a versatile skill set to projects, with a focus on Systems Programming. I blend creativity,
                    coding prowess, and a keen eye for detail to build robust and efficient systems.
                </p>
            </div>
            <div
                ref={skillsRef2}
                className={`w-full flex flex-wrap items-center gap-6 ${skillsRefIsInView2 ? 'opacity-100' : 'opacity-100 translate-y-24'
                    } duration-1000`}
            >
                {skills.map((skill) => {
                    return (
